package com.shopmart.service.order.utility;
...
public class SequenceGenerator extends SequenceStyleGenerator {
	...
	public void configure(Type type, Properties params, ServiceRegistry serviceRegistry)	throws MappingException {
		 ...
		 String dateFormat = ConfigurationHelper.getString(DATE_FORMAT_PARAMETER, params, DATE_FORMAT_DEFAULT).replace("%", "%1$").replace("-", "");
